...
#SRCS = xmoon.c xmn_conf.c
SRCS = $(wildcard *.cc)

#OBJS = xmoon.o xmn_conf.o  这么一个一个增加.o太麻烦，下行换一种写法：把字符串中的.c替换为.o
OBJS = $(SRCS:.cc=.o)

#把字符串中的.c替换为.d
#DEPS = xmoon.d xmn_conf.d
DEPS = $(SRCS:.cc=.d)

#可以指定BIN文件的位置,addprefix是增加前缀函数
#BIN = /mnt/hgfs/linux/xmoon
...
#处理后形如 /mnt/hgfs/linux/xmoon/app/link_obj/xmn_signal2.o /mnt/hgfs/linux/xmoon/app/link_obj/xmn_signal.o
# := 在解析阶段直接赋值常量字符串【立即展开】，而 = 在运行阶段，实际使用变量时再进行求值【延迟展开】
# /mnt/hgfs/linux/xmoon/app/link_obj/xmoon.o   /mnt/hgfs/linux/xmoon/app/link_obj/xmn_conf.o 
...
#这里是诸多.d文件被包含进来，每个.d文件里都记录着一个.o文件所依赖哪些.c和.h文件。内容诸如 xmoon.o: xmoon.c xmn_func.h
...
#.d文件中的内容可能形如：xmoon.o: xmoon.c xmn_func.h
#%.d:%.c
$(DEP_DIR)/%.d:%.cc
#gcc -MM $^ > $@
#.d文件中的内容形如：xmoon.o: xmoon.c xmn_func.h ../signal/xmn_signal.h，但现在的问题是我们的.o文件已经放到了专门的目录
